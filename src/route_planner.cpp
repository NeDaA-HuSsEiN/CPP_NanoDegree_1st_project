...
/**
 * Sort the vector of nodes in descending order.
 */
void RoutePlanner::NodeSort(std::vector<RouteModel::Node*> &v) {
  sort(v.begin(), v.end(), [](const RouteModel::Node* a, const RouteModel::Node* b) {
...
RouteModel::Node *RoutePlanner::NextNode() {
	NodeSort(open_list);
	RouteModel::Node * lower_node = open_list.back();
	open_list.pop_back();
	return lower_node;  
}
